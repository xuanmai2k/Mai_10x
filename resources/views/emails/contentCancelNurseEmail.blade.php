<div style="max-width: 500px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif; background-color: #f9f9f9; border: 1px solid #ccc; border-radius: 5px;">
    <h2 style="text-align: center; font-weight: bold; color: #333; margin-bottom: 20px;">Dear {{ $appointment->nurse->name }},</h2>
    <p style="color: #555; line-height: 1.5em;">The user has canceled the vaccination appointment with you. {{ $appointment->category->name }} vaccines.</p>
