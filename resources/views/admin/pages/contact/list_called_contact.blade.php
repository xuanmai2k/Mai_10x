    ...
    <div class="container" style="margin-bottom: 2%">
        <div class="row">
            <div class="col-md-12 stretch-card grid-margin">
                ...
                <div class="card">
                    <div class="card-body">
                        <h2 class="mb-0">Complete Contact List</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    @forelse ($comContactList as $contact)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-{{ $contact->status ? 'success' : 'danger' }}">{{ $contact->status ? 'Complete' : 'Not yet' }}</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4">No Contact Complete</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                        ...
                        <div class=" clearfix">
                            {{ $comContactList->appends(request()->query())->links() }}
                        </div>
                    </div>
                </div>
            </div>
